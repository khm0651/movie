...
<link rel="stylesheet" type="text/css" href="./styles/interMovieStyle.css">
<meta charset="UTF-8">
...
<div class="tabs">
				...
				<c:if test="${!empty reservation }">
					<c:forEach var="i" begin="0" end="${reservation.listSize -1 }">
						<div class="reservation-item">
							<img src="${reservation.poster[i] }" class="reservation-poster" /> <input type="button" value="예매취소">
	...
	<input type="radio" name="tabs" id="tabtwo">
  	<label for="tabtwo">관심 영화 목록</label>
  	<div class="tab">
					...
					<c:if test="${!empty interMovieId }">
						<c:forEach var="i" begin="0" end="${interMovieSize - 1 }">
							<li>
								...
								<dl class="lst_dsc">
									<dt class="tit">
										<span class="${movieAge[i] }"></span> <a href="https://movie.naver.com${movieDetailHref[i] }"> <font size="2">${movieTitle[i] }</font>
										</a>
									</dt>
										...
										<dl class="info_star">
											<dd>
												<div class="star_t1">
													<span> 
													${movieScore[i] }
													<span class="num">${movieScoreNum1[i] }</span>
													${movieScoreNum2[i] }
													</span>
												</div>
											</dd>
